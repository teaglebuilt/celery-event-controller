...
# source: protos/celery_controller.proto
...
TaskMessage = _reflection.GeneratedProtocolMessageType('TaskMessage', (_message.Message,), {
  ...
  '__module__' : 'protos.celery_controller_pb2'
...
_EVENTSERVER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='EventServer.capture_realtime',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='get_metrics',
    full_name='EventServer.get_metrics',
    index=1,
    containing_service=None,
    input_type=_NULL,
